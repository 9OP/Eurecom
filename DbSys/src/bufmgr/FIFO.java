...
/**
 * class FIFO is a subclass of class Replacer using FIFO algorithm for page replacement
 */
class FIFO extends Replacer {
  ...
  /**
   * Finding a free frame in the buffer pool or choosing a page to replace using FIFO policy
   *
